...
var ExternalComponent = _react["default"].forwardRef(function (props, ref) {
  var src = props.src,
      module = props.module,
      exportName = props["export"],
      extendClass = props.extendClass,
      cors = props.cors,
      rest = _objectWithoutProperties(props, ["src", "module", "export", "extendClass", "cors"]);
  ...
  (0, _react.useEffect)(function () {
    ...
    if (!src) {
      throw new Error("dynamic-import: no url, props: ".concat(JSON.stringify(props, null, 2)));
    }
    ...
    importPromise(src).then(function () {
      ...
      var component = requiredComponent["default"] ? requiredComponent["default"] : requiredComponent[exportName];
      setComponent({
        component: component
      });
    })["catch"](function (e) {
  ...
  if (extendClass) {
    var ExtendedComponent = Component.component(extendClass); // eslint-disable-next-line react/jsx-props-no-spreading

    return _react["default"].createElement(ExtendedComponent, _extends({
      ref: ref
    }, rest));
  } // eslint-disable-next-line react/jsx-props-no-spreading


  return _react["default"].createElement(Component.component, _extends({
    ref: ref
  }, rest));
});
...
ExternalComponent.propTypes = {
  ...
  extendClass: _propTypes["default"].any
};
