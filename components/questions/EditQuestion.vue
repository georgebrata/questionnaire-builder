    ...
    <div class="modal-card" style="width: auto">
        ...
        <section class="modal-card-body">
            ...
            <b-field label="What's the question type?">
                <b-radio-button v-model="question.questionType" class="ml4"
                    native-value="input"
                    type="is-dark">
                    <span>input</span>
                </b-radio-button>

                <b-radio-button v-model="question.questionType"
                ...
                <div class="columns" v-if="isMultipleAnswersQuestion">
                    <div class="column is-12">
                        <strong>What are the answers?
                            <b-button type="is-primary" icon-left="plus" class="button is-outlined is-small ml4" @click="showNewAnswerToAdd()">
                                Add {{this.question.answers > 0 ? 'another answer' : 'an answer'}} 
                            </b-button>
                        </strong>
                    </div>
                </div>
                ...
                <div class="answers is-block radio-btns">
                    ...
                    <div class="is-block mt1" v-for="answer in question.answers" v-if="question.questionType === 'dropdown'" style="width: 50%;">
                        <b-tag>
                            {{answer.answerValue}} 
                        </b-tag>
                        <b-button
                ...
                <b-field v-if="isAddNewAnswerEnabled">
                    <b-input v-model="newAnswer.value"></b-input><b-button type="is-primary" icon-right="plus" @click="appendNewAnswer()" />
                </b-field>
                <span v-for="err in errors" class="is-danger">
                    {{err}}
                </span>
        </section>
        ...
        <footer class="modal-card-foot is-pulled-right">
            ...
            <button :disabled="!isValidQuestion()" class="button is-primary" @click="update()">{{question.questionId ? 'Save' : 'Add'}} Question</button>
        </footer>
    </div>
</form>
</template>
...
export default {
    ...
    computed: {
        isMultipleAnswersQuestion: function() {
            return this.question.questionType === 'radio' || this.question.questionType === 'checkbox' || this.question.questionType === 'dropdown';
        }
    },
    methods: {
        ...
        deleteAnswer: function(answer) {
            let index = this.question.answers.findIndex(a => a.answerId === answer.answerId)
...
.radio-btns .b-radio .control-label, .radio-btns .b-checkbox .control-label {
    width: 50%;
}
